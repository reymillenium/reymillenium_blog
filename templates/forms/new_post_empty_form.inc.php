<fieldset>
    ...
    <div class="form-group">
        <div class="input-group col-md-12">
            ...
            <input type="text" id="txt_post_title" class="form-control" placeholder="Título de la entrada" name="post_title" autofocus>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="input-group col-md-12">
            ...
            <input type="text" id="txt_post_url" class="form-control" placeholder="URL de la entrada" name="post_url">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="input-group col-md-12">
            <textarea id="txta_post_text" name="post_text" class="form-control" rows="12" placeholder=""></textarea>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-md-12">
            <div class="checkbox">
                <label id="lbl_post_is_active"><input type="checkbox" id="chbx_post_is_active" name="post_is_active" value="true" checked> Entrada válida</label>
            </div>
        </div>
    </div>
